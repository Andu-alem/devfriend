...
import { editEvent } from "@/lib/actions/edit-actions"
...
export function EditEventDialog({ 
    ...
    const [ state, formAction, isPending ] = useActionState(editEvent, initialState)
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.append('eventId', String(event.id))// change it to string since formData only handles string
