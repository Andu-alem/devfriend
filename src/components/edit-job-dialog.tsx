...
import { editJob } from "@/lib/actions/edit-actions"
...
export function EditJobDialog({ 
    ...
    const [ state, formAction, isPending ] = useActionState(editJob, initialState)
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.append('jobId', String(job.id)) // change it to string so that it can be handled by FormData
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <DialogFooter>
                        ...
                        <Button type="submit" disabled={isPending}>
                            {isPending ? "Updating..." : "Edit Job Application"}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
