...
import { editProject } from "@/lib/actions/edit-actions"
...
export function EditProjectDialog({ 
    ...
    const [ state, formAction, isPending ] = useActionState(editProject, initialState)
    const [open, setOpen] = useState(false)
    const [techStacks, setTechStacks] = useState<string[]>(project.techStack ?? [])
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.append('projectId', String(project.id))// change it to string since formData only handles string
